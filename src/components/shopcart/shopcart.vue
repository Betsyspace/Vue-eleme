...
//          }];
    ...
    computed: {
        ...
        payDesc() {
            if(this.totalPrice === 0){
                return `￥${this.minPrice}元起送`;  //es6新语法 `${}`替代加号连接字符串
    ...
    methods: {
      ...
      pay() {
          ...
          window.alert(`您需要支付${this.totalPrice}元钱`);
      }
    },
    ...
    transitions: {
      drop: {
        ...
        enter(el){
          /*eslint-disable no-nounuse-vars*/
...
<style lang="scss" rel="stylesheet/scss">
  ...
  .shopcart{
    ...
    .shopcart-list{
      ...
      &.fold-transition{
        transition: all 0.5s;
        transform: translate3d(0,-100%,0);  /*往上是负数*/
      }
